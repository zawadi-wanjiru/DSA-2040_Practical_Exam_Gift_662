...
def create_visualizations(df, df_normalized):
    ...
    plt.close()
    print("  ✓ Saved: visualizations/boxplots.png")
    ...
    plt.close()
    print("  ✓ Saved: visualizations/distributions.png")
...
def main():
    ...
    print("✓ Saved normalized data: iris_normalized.csv")
    ...
    print("✓ Saved training data: iris_train.csv")
    print("✓ Saved testing data: iris_test.csv")

    print("\n" + "=" * 70)
    print("PREPROCESSING AND EXPLORATION COMPLETE!")
    print("=" * 70)
    print("\nGenerated Files:")
    print("  - iris_normalized.csv (normalized dataset)")
    print("  - iris_train.csv (training set)")
    print("  - iris_test.csv (testing set)")
    print("  - visualizations/pairplot.png")
    print("  - visualizations/correlation_heatmap.png")
    print("  - visualizations/boxplots.png")
    print("  - visualizations/distributions.png")
