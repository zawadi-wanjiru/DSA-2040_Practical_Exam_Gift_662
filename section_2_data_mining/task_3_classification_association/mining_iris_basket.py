...
def load_train_test_data():
    ...
    train_df = pd.read_csv('../task_1_preprocessing/iris_train.csv')
    test_df = pd.read_csv('../task_1_preprocessing/iris_test.csv')
...
def compare_classifiers(dt_metrics, knn_metrics):
    ...
    plt.tight_layout()
    plt.savefig('visualizations/classifier_comparison.png', dpi=300, bbox_inches='tight')
...
def display_top_rules(rules, top_n=5):
    ...
    plt.tight_layout()
    plt.savefig('visualizations/association_rules.png', dpi=300, bbox_inches='tight')
...
def main():
    ...
    print("    - visualizations/classifier_comparison.png")
    print("  Part B - Association Rules:")
    print("    - datasets/transactions.csv")
    print("    - visualizations/association_rules.png")
